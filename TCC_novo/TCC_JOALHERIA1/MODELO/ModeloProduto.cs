...
namespace MODELO
{
    public class ModeloProduto
    {
        ...
        public ModeloProduto(int pro_cod,  DateTime data, String pro_nome, String pro_descricao,
        ...
        public DateTime ProData
        {
            get { return this.pro_data; }
            set { this.pro_data = value; }
        }
